export const dict = {
  ...
  "command.terminal.remote": "Remote terminal",
  "command.terminal.remote.description": "Connect to a configured remote server",
  ...
  "prompt.placeholder.ssh": "Enter SSH command...",
  "prompt.placeholder.remoteTask": "e.g. /opt/conda/bin/conda run --no-capture-output -n myenv python train.py",
  ...
  "prompt.ssh.noServers": "No remote servers",
  ...
  "prompt.toast.sshServerRequired.title": "Select a remote server",
  "prompt.toast.sshServerRequired.description": "Configure or choose a project remote server before running SSH commands.",
  "prompt.toast.remoteTaskUnavailable.title": "Remote task unavailable",
  "prompt.toast.remoteTaskUnavailable.description": "Remote tasks can only be started from an experiment session.",
  "prompt.toast.remoteTaskSendFailed.title": "Failed to start remote task",
  ...
  "session.experiment.noData": "No experiment data available",
  "session.experiment.noPlan": "No experiment plan available",
  "session.experiment.noChanges": "No changes in this experiment",
  "session.experiment.noResult": "No experiment result available",
  "session.experiment.changesCount": "{{count}} Changes",
  "session.experiment.status": "Status",
  "session.experiment.status.pending": "Pending",
  "session.experiment.status.running": "Running",
  "session.experiment.status.done": "Done",
  "session.experiment.status.failed": "Failed",
  "session.experiment.status.idle": "Idle",
  "session.experiment.branch": "Experiment Branch",
  "session.experiment.baseline": "Baseline Branch",
  "session.experiment.atom": "Atom",
  "session.experiment.started": "Started",
  "session.experiment.finished": "Finished",
  "session.experiment.loading": "Loading...",
  "session.experiment.loadError": "Failed to load file content",
  ...
  "session.workflow.title": "Workflow",
  "session.workflow.collapse": "Collapse workflow",
  "session.workflow.expand": "Expand workflow",
  "session.workflow.step": "Step",
  "session.workflow.running": "Running",
  "session.workflow.waiting": "Waiting",
  "session.workflow.completed": "Completed",
  "session.workflow.failed": "Failed",
  "session.workflow.failedManual": "Failed by agent",
  "session.workflow.failedAuto": "Stopped to prevent retry loop",
  "session.workflow.cancelled": "Cancelled",

  "session.collab.title": "Collab",
  "session.collab.open": "Open Collab",
  "session.collab.openActive": "Open Collab, {{count}} active",
  "session.collab.tooltipActive": "Collab · {{count}} active",
  "session.collab.running": "Running",
  "session.collab.blocked": "Waiting",
  "session.collab.pending": "Idle",
  "session.collab.empty": "No Collab agents.",
  "session.collab.emptyActive": "No active Collab agents.",
  "session.collab.showCompleted": "Show completed",
  "session.collab.hideCompleted": "Hide completed",
  ...
  "terminal.remote.search": "Select remote server",
  "terminal.remote.empty": "No remote servers configured",
  ...
  "settings.permissions.tool.huggingface_search.title": "Hugging Face Search",
  "settings.permissions.tool.huggingface_search.description": "Search Hugging Face models and datasets",
  "settings.permissions.tool.modelscope_search.title": "ModelScope Search",
  "settings.permissions.tool.modelscope_search.description": "Search ModelScope models and datasets",
  ...
  "pathPicker.search.placeholder": "Search by filename",
  "pathPicker.empty": "No results",
  "pathPicker.loading": "Loading...",
  "pathPicker.cancel": "Cancel",
  "pathPicker.validating": "Validating...",
  "pathPicker.confirm": "Confirm ({{count}})",

  "research.new.entry.title": "New Research Project",
  "research.new.entry.description": "Import papers to quickly start a new research topic",
  "research.new.entry.button": "Create",
  "research.new.title": "New Research Project",
  "research.new.name.label": "Project name",
  "research.new.name.placeholder": "Enter research project name",
  "research.new.location.label": "Location",
  "research.new.location.placeholder": "Enter or select project location",
  "research.new.location.select": "Select folder",
  "research.new.drop.hint": "Drag papers here, or <1>click to select</1>",
  "research.new.drop.note": "Supports PDF files and LaTeX source folders",
  "research.new.papers.label": "Papers",
  "research.new.papers.empty": "No papers selected",
  "research.new.cancel": "Cancel",
  "research.new.create": "Create",
  "research.new.upload.failed": "Upload failed",
  "research.new.create.failed": "Failed to create research project",
