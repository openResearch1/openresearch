...
export const dict = {
  ...
  "session.experiment.noData": "没有实验数据",
  "session.experiment.noPlan": "没有实验计划",
  "session.experiment.noChanges": "此实验没有变更",
  "session.experiment.noResult": "没有实验结果",
  "session.experiment.changesCount": "{{count}} 个变更",
  "session.experiment.status": "状态",
  "session.experiment.status.pending": "待处理",
  "session.experiment.status.running": "运行中",
  "session.experiment.status.done": "已完成",
  "session.experiment.status.failed": "失败",
  "session.experiment.status.idle": "空闲",
  "session.experiment.branch": "实验分支",
  "session.experiment.baseline": "基准分支",
  "session.experiment.atom": "原子",
  "session.experiment.started": "开始时间",
  "session.experiment.finished": "完成时间",
  "session.experiment.loading": "加载中...",
  "session.experiment.loadError": "加载文件内容失败",
  ...
  "session.workflow.title": "流程",
  "session.workflow.collapse": "收起流程",
  "session.workflow.expand": "展开流程",
  "session.workflow.step": "步骤",
  "session.workflow.running": "进行中",
  "session.workflow.waiting": "等待输入",
  "session.workflow.completed": "已完成",
  "session.workflow.failed": "失败",
  "session.workflow.failedManual": "AI 主动失败退出",
  "session.workflow.failedAuto": "为避免重试循环而自动终止",
  "session.workflow.cancelled": "已取消",
  "session.collab.title": "Collab",
  "session.collab.open": "打开 Collab",
  "session.collab.openActive": "打开 Collab，{{count}} 个活跃任务",
  "session.collab.tooltipActive": "Collab · {{count}} 个活跃任务",
  "session.collab.running": "运行中",
  "session.collab.blocked": "等待中",
  "session.collab.pending": "空闲",
  "session.collab.empty": "没有 Collab 智能体",
  "session.collab.emptyActive": "没有活跃的 Collab 智能体",
  "session.collab.showCompleted": "显示已完成",
  "session.collab.hideCompleted": "隐藏已完成",
  "session.collab.stop.button": "停止 Controller",
  "session.collab.stop.title": "停止 Controller",
  "session.collab.stop.confirm": "要停止当前 Controller 及其自动派生的任务吗？",
  "session.collab.stop.description": "人类控制的运行和远端进程将继续。",
  "session.collab.stop.stopping": "正在停止...",
  "session.collab.stop.failed": "停止 Controller 失败",
  "session.new.title": "构建任何东西",
  "session.new.researchTitle": "研究任何问题",
  ...
  "settings.permissions.tool.huggingface_search.title": "Hugging Face 搜索",
  "settings.permissions.tool.huggingface_search.description": "搜索 Hugging Face 模型和数据集",
  "settings.permissions.tool.modelscope_search.title": "ModelScope 搜索",
  "settings.permissions.tool.modelscope_search.description": "搜索 ModelScope 模型和数据集",
  ...
  "sidebar.research.conversations": "项目对话",
  "sidebar.research.controllers": "控制器",
  "sidebar.research.newController": "新建控制器",
  "sidebar.research.controllerCreateFailed": "创建控制器失败",
  "sidebar.research.atoms": "原子列表",

  "session.controller.paths": "路径",
  "session.controller.agents": "智能体",
  "session.controller.results": "结果",
  "session.controller.paths.empty.title": "暂无研究路径",
  "session.controller.paths.empty.description": "该控制器的研究智能体注册路径后，将显示在这里。",
  "session.controller.agents.empty": "暂无智能体",
  "session.controller.results.empty.title": "暂无已接受结果",
  "session.controller.results.empty.description": "结果通过 Reviewer 审核后，将显示在这里。",
  "session.controller.welcome.title": "协调研究",
  "session.controller.welcome.description": "设定目标，Controller 会将工作委派给 Research 智能体并持续同步进展。",
  "session.atom.welcome.title": "推进这个原子",
  "session.atom.welcome.description": "研究主张、收集证据，并为这个原子设计实验。",
  "session.experiment.welcome.title": "执行实验",
  "session.experiment.welcome.description": "准备运行、监控执行过程，并记录实验结果。",
  ...
  "pathPicker.search": "搜索",
  "pathPicker.search.placeholder": "输入文件名搜索",
  "pathPicker.empty": "无匹配结果",
  "pathPicker.loading": "加载中...",
  "pathPicker.cancel": "取消",
  "pathPicker.validating": "验证中...",
  "pathPicker.confirm": "确认选择 ({{count}})",

  "research.new.entry.title": "新建科研项目",
  "research.new.entry.description": "导入论文，快速开始新课题",
  "research.new.entry.button": "新建",
  "research.new.title": "新建科研项目",
  "research.new.name.label": "科研项目名",
  "research.new.name.placeholder": "请输入科研项目名称",
  "research.new.location.label": "创建位置",
  "research.new.location.placeholder": "请输入或选择项目创建位置",
  "research.new.location.select": "选择文件夹",
  "research.new.drop.hint": "拖拽论文到此处，或 <1>点击选择</1>",
  "research.new.drop.note": "支持 PDF 文件和 LaTeX 源码文件夹",
  "research.new.papers.label": "论文",
  "research.new.papers.empty": "暂未选择论文",
  "research.new.cancel": "取消",
  "research.new.create": "创建",
  "research.new.upload.failed": "上传失败",
  "research.new.create.failed": "创建科研项目失败",
