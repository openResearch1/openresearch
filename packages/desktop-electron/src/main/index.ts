...
const APP_IDS: Record<string, string> = {
  dev: "ai.openresearch.desktop.dev",
  beta: "ai.openresearch.desktop.beta",
  prod: "ai.openresearch.desktop",
}
app.setName(app.isPackaged ? APP_NAMES[CHANNEL] : "OpenCode Dev")
app.setPath("userData", join(app.getPath("appData"), app.isPackaged ? APP_IDS[CHANNEL] : "ai.openresearch.desktop.dev"))
...
function sqliteFileExists() {
  ...
  return existsSync(join(base, "openresearch", "openresearch.db"))
}
